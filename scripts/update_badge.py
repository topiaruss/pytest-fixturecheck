...
def update_badge(version):
    ...
    for i, line in enumerate(lines):
        if "PyPI version" in line and "https://pypi.org/project/pytest-fixturecheck/" in line:
            ...
            new_line = before + f"https://pypi.org/project/pytest-fixturecheck/{version}/" + after
            lines[i] = new_line
            badge_found = True
            break
